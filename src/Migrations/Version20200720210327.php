 ...
 */
final class Version20200720210327 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE diplome CHANGE type_id type_id INT DEFAULT NULL, CHANGE specialite_id specialite_id INT DEFAULT NULL, CHANGE date_delivrance date_depot DATE NOT NULL');
        $this->addSql('ALTER TABLE demande CHANGE diplome_id diplome_id INT DEFAULT NULL, CHANGE secretaire_id secretaire_id INT DEFAULT NULL, CHANGE entreprise_id entreprise_id INT DEFAULT NULL, CHANGE laureat_id laureat_id INT DEFAULT NULL, CHANGE etablissement_id etablissement_id INT DEFAULT NULL, CHANGE directeur_pedagogique_id directeur_pedagogique_id INT DEFAULT NULL, CHANGE etat_secretaire etat_secretaire INT DEFAULT 2 NOT NULL, CHANGE date_validation_secretaire date_validation_secretaire DATE DEFAULT NULL, CHANGE date_validation_dp date_validation_dp DATE DEFAULT NULL, CHANGE date_validation_de date_validation_de DATE DEFAULT NULL, CHANGE etat_directeur_pd etat_directeur_pd INT DEFAULT 2 NOT NULL, CHANGE etat_directeur_gn etat_directeur_gn INT DEFAULT 2 NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE demande CHANGE diplome_id diplome_id INT DEFAULT NULL, CHANGE secretaire_id secretaire_id INT DEFAULT NULL, CHANGE entreprise_id entreprise_id INT DEFAULT NULL, CHANGE laureat_id laureat_id INT DEFAULT NULL, CHANGE etablissement_id etablissement_id INT DEFAULT NULL, CHANGE directeur_pedagogique_id directeur_pedagogique_id INT DEFAULT NULL, CHANGE etat_secretaire etat_secretaire INT DEFAULT 0 NOT NULL, CHANGE etat_directeur_pd etat_directeur_pd INT DEFAULT 0 NOT NULL, CHANGE etat_directeur_gn etat_directeur_gn INT DEFAULT 0 NOT NULL, CHANGE date_validation_secretaire date_validation_secretaire DATE DEFAULT \'NULL\', CHANGE date_validation_dp date_validation_dp DATE DEFAULT \'NULL\', CHANGE date_validation_de date_validation_de DATE DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE diplome CHANGE type_id type_id INT DEFAULT NULL, CHANGE specialite_id specialite_id INT DEFAULT NULL, CHANGE date_depot date_delivrance DATE NOT NULL');
        $this->addSql('ALTER TABLE directeur_pedagogique CHANGE etablissement_id etablissement_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE entreprise CHANGE nom_entreprise nom_entreprise VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE logo logo VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE etablissement CHANGE pays_id pays_id INT DEFAULT NULL, CHANGE nom_etablissement nom_etablissement VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE logo logo VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
