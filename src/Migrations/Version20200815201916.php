 ...
 */
final class Version20200815201916 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE diplome (id INT AUTO_INCREMENT NOT NULL, type_id INT DEFAULT NULL, specialite_id INT DEFAULT NULL, code VARCHAR(255) NOT NULL, fichier VARCHAR(255) NOT NULL, date_obtention DATE NOT NULL, date_depot DATE NOT NULL, annee DATE NOT NULL, INDEX IDX_EB4C4D4EC54C8C93 (type_id), INDEX IDX_EB4C4D4E2195E0F0 (specialite_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE entreprise (id INT NOT NULL, nom_entreprise VARCHAR(255) DEFAULT NULL, logo VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE etablissement (id INT NOT NULL, pays_id INT DEFAULT NULL, nom_etablissement VARCHAR(255) DEFAULT NULL, logo VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_20FD592CACA3E3B2 (nom_etablissement), UNIQUE INDEX UNIQ_20FD592CE48E9A13 (logo), INDEX IDX_20FD592CA6E44244 (pays_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
